<script>
    $(document).ready(function(){
        ...
        // Show Data
        var table = $('.tableLaporanSubkategori').DataTable({
            processing: true,
            serverSide: true,
            searching:  true,
            // dom: 'lBfrtip',
            ...
            buttons: [
                {
                    extend: 'print',
                    // autoPrint: false,
                    title:'Laporan Pengaduan per Subkategori',
            ...
            ajax: {
            url: "{{ route('laporan.data.subkategori') }}",
            data: function (d) {
            ...
            columns: [
                ...
                {data: 'id_subkategori', name: 'id_subkategori'},
