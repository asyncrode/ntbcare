    ...
    <div class="block">
        ...
        <div class="row ml-5">
            <div class="col-md-3 mt-5">
                ...
                <select name="subkategori" id="subkategori" class="form-control mb-5">
                    <option value="">All</option>
                    @foreach ($subkategori as $k)
                        <option value="{{$k->id}}">{{$k->subkategori}}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="block-content block-content-full">
            ...
            <table  class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination tableLaporanSubkategori">
                <thead>
                    <tr>
...
@endsection
@push('scripts')
@include('admin.laporan_subkategori.javascript')
@endpush